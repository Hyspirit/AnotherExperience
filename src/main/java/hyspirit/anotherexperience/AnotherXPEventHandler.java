...
public class AnotherXPEventHandler {
	...
	public void onPlayerBreakingBlock(PlayerEvent.BreakSpeed event){
		...
		//I don't know if you can get wich type of tool you're using, so I'm considering that if you have the correct tool, you are harvesting at a rate greater than 1
